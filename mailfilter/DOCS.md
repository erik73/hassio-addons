...
Important: This app requires that the Mailserver app is installed and running!

This app provides a mailfilter for your the Mailserver app.
It can only filter emails for the Mailserver app.
...
Find the "Mailfilter" app and click it.
...
Depending other apps that are installed 6GB might not be enough.
...
Home Assistant. Here is a sample output in the app log:
